...
def test_set_physics_state_loc_and_rot(set_physics_state_env):
    ...
    set_physics_state_env.agents["turtle0"].set_physics_state(new_loc, new_rot, [0, 0, 0], [0, 0, 0])
...
def test_set_physics_state_vel(set_physics_state_env):
    ...
    set_physics_state_env.agents["turtle0"].set_physics_state([0, 0, 0], [0, 0, 0], new_vel, [0, 0, 0])
...
def test_set_physics_state_ang_vel(set_physics_state_env):
    ...
    set_physics_state_env.agents["turtle0"].set_physics_state([0, 0, 0], start_rot, [0, 0, 0], new_ang_vel)
...
def test_set_physics_state_collision(set_physics_state_env):
    ...
    set_physics_state_env.agents["turtle0"].set_physics_state(new_loc, [0, 0, 0], [0, 0, 0], [0, 0, 0])
